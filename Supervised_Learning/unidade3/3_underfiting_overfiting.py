...
# Add a title
plt.title("Variação de knn")

# Plot training accuracies
plt.plot(list(train_accuracies.keys()), list(train_accuracies.values()), label="train")

# Plot test accuracies
plt.plot(list(test_accuracies.keys()), list(test_accuracies.values()), label="test")
