...
def load_carros_dataset():
    return pd.read_csv("C:/Users/jfm12/Downloads/nivaldo/IA-CD/AV1/dataset/CarPrice_Assignment.csv")

def load_chocolate_dataset():
    return pd.read_csv("C:/Users/jfm12/Downloads/nivaldo/IA-CD/AV1/dataset/chocolate.csv")
