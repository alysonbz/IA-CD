...
# Add a title
plt.title("KNN: Variação da acurácia com o número de vizinhos")

# Plot training accuracies
plt.plot(neighbors, list(train_accuracies.values()), label="Treinamento")

# Plot test accuracies
plt.plot(neighbors, list(test_accuracies.values()), label="Teste")
