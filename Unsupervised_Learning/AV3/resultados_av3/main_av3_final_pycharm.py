...
# Kauê Cruz e Abimael Filho
# Questões 1 a 7 alinhadas ao PDF da avaliação
# Código para rodar no PyCharm
#
# Instalação:
# pip install pandas numpy matplotlib scikit-learn scipy openpyxl
#
# Coloque este arquivo .py na mesma pasta do arquivo:
# online+retail.zip
# ou
# Online Retail.xlsx
...
def questao_7(clientes, features):
    ...
    target_classificacao = "cluster_kmeans"
    ...
    pca_2d_df[target_classificacao] = y.values
...
Essa escolha permite avaliar se o PCA preserva a estrutura de agrupamento encontrada pelo K-Means na Questão 3.
...
def main():
    ...
    print(f"Arquivos gerados na pasta: {RESULTS_DIR}")
